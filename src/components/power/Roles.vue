...
export default {
    ...
    methods: {
        ...
        async removeRightById(role, rightId) {
            ...
            // this.getRolesList() // 刷新数据，会发生页面的完整渲染
            // 为角色信息重新赋值权限
            role.children = res.data // 防止列表刷新，把最新的直接赋值给children属性
        },
        // 展示分配权限的对话框
        ...
        async allotRights() {
            ...
            this.getRolesList() //  刷新分配权限列表
            this.setRightDialogVisible = false // 关闭分配权限的对话框
        }
    }
}
</script>
